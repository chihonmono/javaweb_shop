...
<table class="table">
    ...
    <c:forEach items="${myOrders}" var="myOrders" varStatus="s">
        <tr>
            <td>${myOrders.g_img}</td>
            <td>${myOrders.g_name}</td>
            <td>${myOrders.g_price}</td>
            <td>${myOrders.o_num}</td>
            <td>${myOrders.o_totalPrice}</td>
            <td>${myOrders.o_status}</td>
            <td>${myOrders.o_time}</td>
        </tr>
    </c:forEach>
